    ...
    { 
        ...
        { 
            ...
            new Produto(){ 
                ...
                Descricao = "Play Has No Limits™ Jogar Não Tem Limites PlayStation®5. O console PS5™ oferece novas possibilidades de jogabilidade que você nunca imaginou. Reproduza jogos para PS5 e PS4 em Blu-ray Disc. Além disso, você também pode baixarjogos ...", 
                Preco = 3699.99M, 
                Estoque = 6, 
                CategoriaId = 2, 
            ...
            new Produto(){ 
                ...
                Descricao = "Cadeira Gamer Fortt Lípsia Vermelha - CGF002-V Seja para trabalhar, estudar ou para seu lazer, a cadeira tornou-se um item essencial para o dia adia. Agora ela não só é mais um item de decoração da casa ou de uso esporádico", 
                Preco = 221.11M, 
                Estoque = 30, 
                CategoriaId = 2, 
